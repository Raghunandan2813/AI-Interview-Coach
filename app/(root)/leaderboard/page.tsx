  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center pt-8 pb-20 px-4 md:px-8 max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <p className="text-light-400 max-w-lg">Rank up by completing real AI Interviews. Total score is the accumulation of every interview feedback score you've generated.</p>
      </div>
      ...
      {leaderboard.length >= 3 && (
        <div className="flex items-end justify-center gap-2 sm:gap-6 w-full mb-16 h-64 mt-10">
          ...
          <div className="flex flex-col items-center flex-1 max-w-[120px] animate-in slide-in-from-bottom-8 duration-700 delay-100">
            ...
            <span className="text-primary-200 font-black mb-3">{leaderboard[1].totalScore} pts</span>
          ...
          <div className="flex flex-col items-center flex-1 max-w-[140px] z-10 animate-in slide-in-from-bottom-12 duration-700">
            ...
            <span className="text-yellow-400 font-black mb-3 text-lg">{leaderboard[0].totalScore} pts</span>
          ...
          <div className="flex flex-col items-center flex-1 max-w-[120px] animate-in slide-in-from-bottom-6 duration-700 delay-200">
            ...
            <span className="text-amber-600 font-black mb-3">{leaderboard[2].totalScore} pts</span>
      ...
      <div className="w-full bg-dark-200/50 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-[var(--shadow-soft)]">
        ...
        <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-dark-300/50 border-b border-white/5 text-xs font-semibold text-light-600 uppercase tracking-wider">
          ...
          <div className="col-span-4 md:col-span-4">Candidate</div>
          <div className="col-span-3 text-right">Total Score</div>
          <div className="col-span-3 md:col-span-3 hidden md:flex justify-end pr-2 text-right">Achievements</div>
        </div>
            ...
            leaderboard.map((user, index) => (
              ...
              >
                ...
                <div className="col-span-4 md:col-span-4 flex flex-col justify-center">
                  ...
                  <span className="text-xs text-light-600 mt-1">{user.interviewsCompleted} Interviews</span>
                </div>
                ...
                {/* Badges */}
                <div className="col-span-3 md:col-span-3 flex justify-end gap-1 flex-wrap hidden md:flex items-center pl-2">
