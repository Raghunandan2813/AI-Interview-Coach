              ...
              {questions[currentQIndex].options.map((opt, i) => {
                ...
                return (
                  <button
                    ...
                    disabled={isRevealed}
                    className={`text-left w-full p-5 rounded-2xl border transition-all duration-300 relative overflow-hidden group ${!isRevealed
                  ...
                  >
                    <div className="flex items-center gap-4 relative z-10">
                      <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center font-bold text-sm ${!isRevealed ? "border-white/10 text-light-400 group-hover:border-primary-200/50"
